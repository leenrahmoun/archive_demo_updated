        ...
        {isDataEntry ? (
          <label className="form-field full-row">
            ...
            <small className="muted">
              {hasAuditors
                ? "سيظهر هذا المدخل فقط في طابور المراجعة الخاص بالمدقق المحدد."
        ...
        <div className="card control-panel-card--accent">
          <div className="control-panel-card__header">
            <div>
              ...
              <p className="muted">الرؤية في طابور المراجعة تعتمد مباشرة على هذا الربط.</p>
            </div>
          </div>
          ...
          <div className="control-panel-rules">
            ...
            <p>
              يرى <strong>المدير</strong> جميع عناصر الطابور ويمكنه إدارة المستخدمين والأدوار بالكامل.
            </p>
            <p>
